    ...
    <header className='h-[7vh] md:h-[10vh] border-b border-secondary-100 p-8 flex items-center justify-end'>
        <nav className='flex items-center gap-x-4'>
            <Menu menuButton={<MenuButton className='flex items-center gap-x-2 hover:bg-secondary-100 py-2 px-4 rounded-lg'>
                <img src='/src/assets/img/pfp.jpg' className='w-6 h-6 object-cover rounded-full'/>
                <span>Administrador</span>
                <IoIosArrowDown/>
            </MenuButton>} transition menuClassName="bg-secondary-100 p-4">
                ...
                <img src='/src/assets/img/pfp.jpg' className='w-8 h-8 object-cover rounded-full'/>
