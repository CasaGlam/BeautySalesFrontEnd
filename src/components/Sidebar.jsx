        ...
        <ul>
          ...
          <li>
            ...
            >
              ...
              <PiChartLineUpBold className="text-primary" />
              Ventas
              </span>
              <IoIosArrowDown   className={`mt-1 ${showSubMenu && "rotate-180"} transition-all`}/>
            </button>
          ...
          <li>
            <Link
              ...
              className="flex items-center gap-4 py-2 px-4 rounded-lg hover:bg-secondary-900 transition-colors"
            >
              <PiChartLineDownBold className="text-primary" />
              Compras
            </Link>
          </li>
          <li>
          ...
          <li>
            ...
            >
              ...
              <IoIosArrowDown   className={`mt-1 ${showSubMenu1 && "rotate-180"} transition-all`}/>
            </button>
